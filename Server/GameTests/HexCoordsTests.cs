...
namespace GameTests {
    public class HexCoordsTests {
        ...
        public void Should_convert_to_offset_coordinates_correctly() {
            ...
            Assert.AreEqual(new OffsetCoords(10, 5), coord.ToOffset());
            coord = new HexCoords(7, 3);
            Assert.AreEqual(new OffsetCoords(8, 3), coord.ToOffset());
            coord = new HexCoords(-1, 2);
            Assert.AreEqual(new OffsetCoords(0, 2), coord.ToOffset());
        }
